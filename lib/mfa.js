...
(function() {
     ...
     * @private
     */
    Mfa.prototype.seedRNG = function (seedHex) {
        var self = this,
            entropyBytes;
    ...
    Mfa.prototype.init = function(successCb, errorCb) {
        ...
        self.request({ url: settingsUrl }, function(err, settingsData) {
            ...
            self.seedRNG(settingsData.seedValue);
     ...
     * @param {function(Error)} errorCb - Callback on failure
     */
    Mfa.prototype.verify = function (userId, clientId, successCb, errorCb) {
        var self = this,
            reqData = {};
     ...
     * @param {function} pinCb
     * @param {function} successCb - Callback on success
     * @param {function(Error)} errorCb - Callback on failure
     */
    Mfa.prototype.register = function (userId, registrationCode, pinCb, successCb, errorCb) {
        var self = this,
            passPin;
     ...
     * @returns {(string|boolean)} - The value of the user property of false if it doesn't exist
     */
